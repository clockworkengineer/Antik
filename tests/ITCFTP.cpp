...
{
    commonOptions.add_options()("server,s", po::value<std::string>(&argData.serverName)->required(), "FTP Server name")("port,o", po::value<std::string>(&argData.serverPort)->required(), "FTP Server port")("user,u", po::value<std::string>(&argData.userName)->required(), "Account username")("password,p", po::value<std::string>(&argData.userPassword)->required(), "User password")("local,l", po::value<std::string>(&argData.localDirectory)->required(), "Local directory")("files,f", po::value<std::vector<std::string>>(&argData.fileList)->multitoken()->required(), "Files")("stress,t", po::value<int>(&argData.stressTestCount), "Stress test repeat count")("general,g", po::value<int>(&argData.generalTestCount), "General test repeat count");
}
//
