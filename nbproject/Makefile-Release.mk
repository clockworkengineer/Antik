...
${OBJECTDIR}/classes/CApprise.o: classes/CApprise.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CApprise.o classes/CApprise.cpp

${OBJECTDIR}/classes/CCurl.o: classes/CCurl.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CCurl.o classes/CCurl.cpp

${OBJECTDIR}/classes/CFTP.o: classes/CFTP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CFTP.o classes/CFTP.cpp

${OBJECTDIR}/classes/CFile.o: classes/CFile.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CFile.o classes/CFile.cpp

${OBJECTDIR}/classes/CIMAP.o: classes/CIMAP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAP.o classes/CIMAP.cpp

${OBJECTDIR}/classes/CIMAPBodyStruct.o: classes/CIMAPBodyStruct.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAPBodyStruct.o classes/CIMAPBodyStruct.cpp

${OBJECTDIR}/classes/CIMAPParse.o: classes/CIMAPParse.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAPParse.o classes/CIMAPParse.cpp

${OBJECTDIR}/classes/CMIME.o: classes/CMIME.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CMIME.o classes/CMIME.cpp

${OBJECTDIR}/classes/CPath.o: classes/CPath.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CPath.o classes/CPath.cpp

${OBJECTDIR}/classes/CRedirect.o: classes/CRedirect.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CRedirect.o classes/CRedirect.cpp

${OBJECTDIR}/classes/CSCP.o: classes/CSCP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSCP.o classes/CSCP.cpp

${OBJECTDIR}/classes/CSFTP.o: classes/CSFTP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSFTP.o classes/CSFTP.cpp

${OBJECTDIR}/classes/CSMTP.o: classes/CSMTP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSMTP.o classes/CSMTP.cpp

${OBJECTDIR}/classes/CSSHChannel.o: classes/CSSHChannel.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSSHChannel.o classes/CSSHChannel.cpp

${OBJECTDIR}/classes/CSSHSession.o: classes/CSSHSession.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSSHSession.o classes/CSSHSession.cpp

${OBJECTDIR}/classes/CSocket.o: classes/CSocket.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSocket.o classes/CSocket.cpp

${OBJECTDIR}/classes/CTask.o: classes/CTask.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CTask.o classes/CTask.cpp

${OBJECTDIR}/classes/CZIP.o: classes/CZIP.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CZIP.o classes/CZIP.cpp

${OBJECTDIR}/classes/CZIPIO.o: classes/CZIPIO.cpp
	${MKDIR} -p ${OBJECTDIR}/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CZIPIO.o classes/CZIPIO.cpp
...
${OBJECTDIR}/classes/implementation/CFileEventNotifier.o: classes/implementation/CFileEventNotifier.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/implementation/CFileEventNotifier.o classes/implementation/CFileEventNotifier.cpp

${OBJECTDIR}/utility/FTPUtil.o: utility/FTPUtil.cpp
	${MKDIR} -p ${OBJECTDIR}/utility
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/FTPUtil.o utility/FTPUtil.cpp

${OBJECTDIR}/utility/SCPUtil.o: utility/SCPUtil.cpp
	${MKDIR} -p ${OBJECTDIR}/utility
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SCPUtil.o utility/SCPUtil.cpp

${OBJECTDIR}/utility/SFTPUtil.o: utility/SFTPUtil.cpp
	${MKDIR} -p ${OBJECTDIR}/utility
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SFTPUtil.o utility/SFTPUtil.cpp

${OBJECTDIR}/utility/SSHChannelUtil.o: utility/SSHChannelUtil.cpp
	${MKDIR} -p ${OBJECTDIR}/utility
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SSHChannelUtil.o utility/SSHChannelUtil.cpp

${OBJECTDIR}/utility/SSHSessionUtil.o: utility/SSHSessionUtil.cpp
	${MKDIR} -p ${OBJECTDIR}/utility
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SSHSessionUtil.o utility/SSHSessionUtil.cpp
...
${TESTDIR}/tests/ITCApprise.o: tests/ITCApprise.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ITCApprise.o tests/ITCApprise.cpp


${TESTDIR}/tests/UTCFile.o: tests/UTCFile.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UTCFile.o tests/UTCFile.cpp


${TESTDIR}/tests/UTCIMAPParse.o: tests/UTCIMAPParse.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UTCIMAPParse.o tests/UTCIMAPParse.cpp


${TESTDIR}/tests/UTCPath.o: tests/UTCPath.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UTCPath.o tests/UTCPath.cpp


${TESTDIR}/tests/UTCSMTP.o: tests/UTCSMTP.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UTCSMTP.o tests/UTCSMTP.cpp


${TESTDIR}/tests/UTCTask.o: tests/UTCTask.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UTCTask.o tests/UTCTask.cpp
...
${OBJECTDIR}/classes/CApprise_nomain.o: ${OBJECTDIR}/classes/CApprise.o classes/CApprise.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CApprise_nomain.o classes/CApprise.cpp;\
	else  \
...
${OBJECTDIR}/classes/CCurl_nomain.o: ${OBJECTDIR}/classes/CCurl.o classes/CCurl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CCurl_nomain.o classes/CCurl.cpp;\
	else  \
...
${OBJECTDIR}/classes/CFTP_nomain.o: ${OBJECTDIR}/classes/CFTP.o classes/CFTP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CFTP_nomain.o classes/CFTP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CFile_nomain.o: ${OBJECTDIR}/classes/CFile.o classes/CFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CFile_nomain.o classes/CFile.cpp;\
	else  \
...
${OBJECTDIR}/classes/CIMAP_nomain.o: ${OBJECTDIR}/classes/CIMAP.o classes/CIMAP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAP_nomain.o classes/CIMAP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CIMAPBodyStruct_nomain.o: ${OBJECTDIR}/classes/CIMAPBodyStruct.o classes/CIMAPBodyStruct.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAPBodyStruct_nomain.o classes/CIMAPBodyStruct.cpp;\
	else  \
...
${OBJECTDIR}/classes/CIMAPParse_nomain.o: ${OBJECTDIR}/classes/CIMAPParse.o classes/CIMAPParse.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CIMAPParse_nomain.o classes/CIMAPParse.cpp;\
	else  \
...
${OBJECTDIR}/classes/CMIME_nomain.o: ${OBJECTDIR}/classes/CMIME.o classes/CMIME.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CMIME_nomain.o classes/CMIME.cpp;\
	else  \
...
${OBJECTDIR}/classes/CPath_nomain.o: ${OBJECTDIR}/classes/CPath.o classes/CPath.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CPath_nomain.o classes/CPath.cpp;\
	else  \
...
${OBJECTDIR}/classes/CRedirect_nomain.o: ${OBJECTDIR}/classes/CRedirect.o classes/CRedirect.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CRedirect_nomain.o classes/CRedirect.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSCP_nomain.o: ${OBJECTDIR}/classes/CSCP.o classes/CSCP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSCP_nomain.o classes/CSCP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSFTP_nomain.o: ${OBJECTDIR}/classes/CSFTP.o classes/CSFTP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSFTP_nomain.o classes/CSFTP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSMTP_nomain.o: ${OBJECTDIR}/classes/CSMTP.o classes/CSMTP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSMTP_nomain.o classes/CSMTP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSSHChannel_nomain.o: ${OBJECTDIR}/classes/CSSHChannel.o classes/CSSHChannel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSSHChannel_nomain.o classes/CSSHChannel.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSSHSession_nomain.o: ${OBJECTDIR}/classes/CSSHSession.o classes/CSSHSession.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSSHSession_nomain.o classes/CSSHSession.cpp;\
	else  \
...
${OBJECTDIR}/classes/CSocket_nomain.o: ${OBJECTDIR}/classes/CSocket.o classes/CSocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CSocket_nomain.o classes/CSocket.cpp;\
	else  \
...
${OBJECTDIR}/classes/CTask_nomain.o: ${OBJECTDIR}/classes/CTask.o classes/CTask.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CTask_nomain.o classes/CTask.cpp;\
	else  \
...
${OBJECTDIR}/classes/CZIP_nomain.o: ${OBJECTDIR}/classes/CZIP.o classes/CZIP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CZIP_nomain.o classes/CZIP.cpp;\
	else  \
...
${OBJECTDIR}/classes/CZIPIO_nomain.o: ${OBJECTDIR}/classes/CZIPIO.o classes/CZIPIO.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/CZIPIO_nomain.o classes/CZIPIO.cpp;\
	else  \
...
${OBJECTDIR}/classes/implementation/CFileEventNotifier_nomain.o: ${OBJECTDIR}/classes/implementation/CFileEventNotifier.o classes/implementation/CFileEventNotifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/implementation/CFileEventNotifier_nomain.o classes/implementation/CFileEventNotifier.cpp;\
	else  \
...
${OBJECTDIR}/utility/FTPUtil_nomain.o: ${OBJECTDIR}/utility/FTPUtil.o utility/FTPUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/FTPUtil_nomain.o utility/FTPUtil.cpp;\
	else  \
...
${OBJECTDIR}/utility/SCPUtil_nomain.o: ${OBJECTDIR}/utility/SCPUtil.o utility/SCPUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SCPUtil_nomain.o utility/SCPUtil.cpp;\
	else  \
...
${OBJECTDIR}/utility/SFTPUtil_nomain.o: ${OBJECTDIR}/utility/SFTPUtil.o utility/SFTPUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SFTPUtil_nomain.o utility/SFTPUtil.cpp;\
	else  \
...
${OBJECTDIR}/utility/SSHChannelUtil_nomain.o: ${OBJECTDIR}/utility/SSHChannelUtil.o utility/SSHChannelUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SSHChannelUtil_nomain.o utility/SSHChannelUtil.cpp;\
	else  \
...
${OBJECTDIR}/utility/SSHSessionUtil_nomain.o: ${OBJECTDIR}/utility/SSHSessionUtil.o utility/SSHSessionUtil.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iclasses/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/SSHSessionUtil_nomain.o utility/SSHSessionUtil.cpp;\
	else  \
